...
import { Button, Input, Select, Toggle, Radio } from "@/components/common";
import { useAppDispatch } from "@/store/hooks";
import { addBanner, getCategories, getTrafficUnits } from "@/store/user/userAPI";
...
const AddBanner: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      await dispatch(
        addBanner({ banner: payload, token })
      ).unwrap();
